...
func TestCreateAccountAPI(t *testing.T) {
	...
	testCase := []struct {
		name          string
		body          gin.H
		setupAuth     func(t *testing.T, request *http.Request, tokenMakeer token.Maker)
		buildStubs    func(store *mockdb.MockStore)
	...
	}{
		{
			...
			setupAuth: func(t *testing.T, request *http.Request, tokenMakeer token.Maker) {
				addAuthorization(t, request, tokenMakeer, authorizationTypeBearer, user.Username, role, time.Minute)
			},
			buildStubs: func(store *mockdb.MockStore) {
